...
const messages = defineMessages({
  greeting: {
    id: "greeting",
    defaultMessage:
      "Hi, I'm a software developer based in <span>Montreal, QC</span>."
  },
  homeIntro1: {
    id: "homeIntro1",
    defaultMessage:
      "In a few words : Java, Agile, web development, automation, and simplicity."
  },
  homeIntro2: {
    id: "homeIntro2",
    defaultMessage:
      "I'm also a fan of clean coding, Linux, cloud development, CI/CD, TDD, and more. Moreover, I enjoy exploring solutions for software design and architecture."
  },
  homeIntro3: {
    id: "homeIntro3",
